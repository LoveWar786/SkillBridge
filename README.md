...
- **AI Engine:** Google GenAI SDK (Gemini 3.1 Flash Lite, Gemini 3.5 Flash, Gemini 3.1 Pro)
...
graph TD;
    ...
    subgraph AI [Google GenAI]
        ...
        G_Flash{Gemini 3.5 Flash}
        G_Pro{Gemini 3.1 Pro}
        G_TTS{Gemini 3.1 Flash TTS}
...
**1. The Parsing & Analysis Agents (Gemini 3.1 Flash Lite / 3.5 Flash / 3.1 Pro):**
...
**3. The Voice Agent (Gemini 3.1 Flash TTS):**
